...
public:
  readConfig() {
    backgroundScales.resize(kNnuebkg, 1.0);
    overallScale = 1.0;
  }
  ...
  double      minShowerGap;
  // This vector allows scaling of each background by a constant factor,
  // independently
  std::vector<float> backgroundScales;
  float overallScale;
