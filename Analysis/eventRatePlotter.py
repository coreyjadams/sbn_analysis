...
for det in detectors:
    ...
    path = "~/Dropbox/Talks/BeamUpgradeMeeting/HornUpgradePlots2/"

    plotName = "forceScale_upgrade_nue_appearance_{d}_{l}_{d2}_{s2}".format(d=detectorsFancy[det],
                                                         l=baselinesFancy[det], d2=dm2, s2=sin22th)
    # canvasList[-1].Print(plotName + ".pdf", "pdf");
    # canvasList[-1].Print(plotName + ".png", "png");

    # Write the data out into a text file, too:
    fileName = "eventRates_{d}_{l}_{d2}_{s2}.txt".format(d=detectorsFancy[det],
