...
public:
      ...
      // Can scale the cosmic rates up or down independently:
      ...
      // Can scale the cosmic rates up or down independently:
      void setUbooneDirtScale(double d) {ubooneDirtScale = d;}
      void setLAr1NDDirtScale(double d) {LAr1NDDirtScale = d;}
      void setIcarusDirtScale(double d) {icarusDirtScale = d;}

      // Can scale the cosmic rates up or down independently:
      void setUboonePhotonScale(double d) {uboonePhotonScale = d;}
      void setLAr1NDPhotonScale(double d) {LAr1NDPhotonScale = d;}
      void setIcarusPhotonScale(double d) {icarusPhotonScale = d;}
...
private:
      ...
      double ubooneDirtScale;  // Scale the dirt event rates uniformly, uboone
      double LAr1NDDirtScale;  // Scale the dirt event rates uniformly, near det
      double icarusDirtScale;  // Scale the dirt event rates uniformly, far det

      double uboonePhotonScale; // Scale the photon event rates uniformly, uboone
      double LAr1NDPhotonScale; // Scale the photon event rates uniformly, near det
      double icarusPhotonScale; // Scale the photon event rates uniformly, far det
      ...
      std::vector<double> dirtScales;
      std::vector<double> photonScales;
