...
#include <string>
  ...
  void Utils::setMC_Generation(int g, std::string twoHornConfig){
    mc_generation = g; 
    reconfigure(twoHornConfig);
    return;
  }

  void Utils::reconfigureTwoHorn(std::string twoHornConfig){
    if (fHorn2Boost != 0){
      delete fHorn2Boost;
    }
  ...
  void Utils::reconfigure(std::string twoHornConfig){
