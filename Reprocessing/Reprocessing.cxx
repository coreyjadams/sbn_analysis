#ifndef REPROCESSING_CXX
#define REPROCESSING_CXX

#define Reprocessing_cxx
#include "Reprocessing.h"

#define print(a) ( std::cout << a << std::endl)


void Reprocessing::Loop(std::string signal,
                              int iDet,
                              int iLoc,
                              Long64_t max_entry,
    ...
    */
    ...
    /**
      ...
      **/     
       ...
       int kNueFromNueCC_muon       = 0;
       int kNueFromNueCC_chargeKaon = 1;
       int kNueFromNueCC_neutKaon   = 2;
       int kNueFromEScatter         = 3;
       int kNueFromNC_pi0           = 4;
       int kNueFromNC_singlePhot    = 5;
       int kNueFromNumuCC           = 6;
       int kDirt                    = 7;
       int kOther                   = 8;
